...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            <h1 class="h3 mb-0 w-100 text-gray-800">產品組合管理 - 編輯</h1>
        </div>
                                    ...
                                    <x:form::form method="PUT" id="form_post" enctype="multipart/form-data"
                                        ...
                                        <div class="mt-3">
                                            <x:form::select name="product_mix1" label="組合商品 1" class="form-control"
                                                :options="$product_mix1_selected" :selected="$productMix->product_mix1" required />
                                        </div>

                                        <div class="mt-3">
                                            <x:form::select name="product_mix2" label="組合商品 2" class="form-control"
                                                :options="$product_mix2_selected" :selected="$productMix->product_mix2" />
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            <x:form::select class="form-control" name="status" label="啓用狀態"
                                                :options="[1 => '啓用', 0 => '停用']" :selected="[$productMix->status]" />
                                        </div>
