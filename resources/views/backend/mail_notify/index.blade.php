...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Mail 樣板管理</h1>
        </div>
...
<script>
    ...
    const edit_row = (id) => {
        location.href = '/backend/mail_notify/' + id + '/edit';
    }

    const add_row = () => {
        location.href = '/backend/mail_notify/create';
    }


    const delete_row = (id) => {
        if(confirm('確定刪除？')){
            location.href = '/backend/mail_notify/destory/' + id;
        }
    }
</script>
@endsection
