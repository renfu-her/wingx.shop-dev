...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">知識百科 - 編輯</h1>
        </div>
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <x:form::form method="PUT" id="form_post" enctype="multipart/form-data"
                                        :action="route('qa.update', $qa->id)" :bind="$qa">

                                        <div class="mt-                                        <div class="mt-3">
                                            <x:form::input name="question" label="問題" required />
                                        </div>

                                        <div class="mt-3">
                                            <x:form::textarea name="answer" label="回答" rows="10" />
                                        </div>
                                        ...
                                        <div class="mt-3 text-center">
                                            <x:form::button.link class="btn-secondary" href="/backend/qa">
                                                取消
                                            </x:form::button.link>
