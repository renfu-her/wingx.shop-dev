...
return [
    ...
    "EXPRESS_MERCHANT_ID_DEV" => env("EXPRESS_MERCHANT_ID_DEV", "2000132"),
    "EXPRESS_HASH_KEY_DEV" => env("EXPRESS_HASH_KEY_DEV", "5294y06JbISpM5x9"),
    "EXPRESS_HASH_IV_DEV" => env("EXPRESS_HASH_IV_DEV", "v77hoKGq4kWxNNIS"),
